...
onAuthStateChanged(auth, async (user) => {
  ...
  if (isUserSuperAdmin) {
    ...
    if (window.innerWidth <= 480 && adminDropdownBtn) {
      adminDropdownBtn.setAttribute('style', 'display: inline; position: relative !important; top: -8px !important; margin-top: 0 !important; font-family: inherit !important; font-weight: normal !important; font-size: 0.85em !important;');
    }
