    ...
    if (isAdmin) {
      ...
      if (adminDropdownBtn) {
        ...
        if (window.innerWidth <= 480) {
          adminDropdownBtn.setAttribute('style', 'display: flex; position: relative !important; margin-top: -10px !important; font-family: inherit !important; font-weight: normal !important;');
        }
      }
